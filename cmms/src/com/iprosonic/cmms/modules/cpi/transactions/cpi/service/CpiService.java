...
public class CpiService {
	...
	public void generateCpiPdf(String cpiCd) {
		...
		try {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport(cpiJrxmlPath, map, jds);
			JasperExportManager.exportReportToPdfFile(jasperPrint, dest.getPath());
	...
	public void generateCpiExcel(String cpiCd) {
		...
		try {
			...
			exporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, dest.getPath());
	...
	public void generateMWasReport(String fromDate, String toDate, String cpiCd, String unitCd, String cpiStatus, String assetType, String correctiveActionDoneBy1,
			String typeOfCpi, String impactToCoustomer, String effectOnCustomer, String sourceOfCpi, String subSourceOfCpi, String groupCd, String subGroupCd, String category,
			String subCategory, String prcaDoneBy, String frcaDoneBy) {

		CpiDAOImpl cpiDAOImpl = new CpiDAOImpl();
		List<CpiBean> cpiBeansList = cpiDAOImpl.getCpiList(fromDate, toDate, cpiCd, unitCd, cpiStatus, assetType, correctiveActionDoneBy1, typeOfCpi, impactToCoustomer,
				effectOnCustomer, sourceOfCpi, subSourceOfCpi, groupCd, subGroupCd, category, subCategory, prcaDoneBy, frcaDoneBy);
	...
	public List<CpiBean> getCpi(String fromDate, String toDate, String cpiCd, String cpiStatus, String assertCd, String sectionSrNo) {
